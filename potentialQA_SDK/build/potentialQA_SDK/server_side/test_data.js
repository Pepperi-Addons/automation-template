...
const installedAddons = {
    ...
    'Item Trade Promotions': '',
    'Order Trade Promotions': '',
    'Package Trade Promotions': '',
};
// Get the Tests Data
async function TestDataTests(generalService, tester, options = { IsAllAddons: true, IsUUID: false }) {
    ...
    describe('Test Data', async () => {
        ...
        it(`Tested User: ${service.getClientData('UserEmail')} UserID: ${service.getClientData('UserID')} DistributorID: ${service.getClientData('DistributorID')}`, () => {
            expect(service.getClientData('UserEmail')).to.contain('@');
        });
        if (options.IsUUID) {
            it(`UserUUID: ${service.getClientData('UserUUID')} DistributorUUID: ${service.getClientData('DistributorUUID')}`, () => {
...
exports.TestDataTests = TestDataTests;
